...
\begin{minipage}{0.6\textwidth}
    ...
    \faMicrosoft \quad \href{mailto:andreadonadello@outlook.com}{\ul{andreadonadello@outlook.com}} \vspace{0.15cm}\\
    \faLinkedin \quad \href{https://linkedin.com/in/andreadonadello}{\ul{linkedin.com/in/andreadonadello}} \vspace{0.15cm}\\
    \faGithub \quad \href{https://github.com/ddonazz}{\ul{github.com/ddonazz}} \\
\end{minipage}
\hfill
\begin{minipage}{0.3\textwidth}
    ...
    \begin{tikzpicture}
        \clip (0,0)  circle (2cm) ;
        \node[anchor=center] at (0,0) {\includegraphics[width=5cm]{profile_photo.jpg}}; 
...
\section{Education}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            {Jun. 2024 - Present}
            {International UniNettuno University}
            {Rome, Italy}
        \resumeSubheading
...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading{Backend Projects}{Java, SpringBoot, PostgreSQL, Oracle, Tomcat, Wildfly}{June 2022 -- Present}
            ...
            \resumeItemListEnd
        \resumeProjectHeading{\href{https://github.com/ddonazz/ml-pipeline}{\ul{Machine Learning Pipeline}}}{Scala, Akka, Kafka, Spark, Hadoop}{November 2023}
            \resumeItemListStart
...
\section{Technical Skills}
    \begin{itemize}[leftmargin=0.025in, label={}]
        \small{\item{
            ...
            \textbf{Programming Languages:} Java (Expert), Scala, C, SQL (PostgreSQL, Oracle) \\
